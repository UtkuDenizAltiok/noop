...
description: "Where the Lift Log stands upstream — #2098, #2099, #2232, #2233, #2386 merged; the Lift Log follow-up #2403 and the diagnostics PR #2402 both MERGED 23 Sep; NOOP optimisation #2415-#2418 merged, #2419/#2420/#2422 open. Full state in dist/STATE.md."
metadata:
  node_type: memory
  type: project
