...
- **#2402 MERGED 23 Sep** as `94a71b04` (upstream's standard-HR log line summarised; not the Lift Log's). ryanbr
  ...
  Build `8351bc7` (23 Sep, = upstream main) carries both. Two NOOP optimisation PRs prepared 23 Sep (Live HR banner
  pushes; workout HR once a second) — see `dist/STATE.md`.
