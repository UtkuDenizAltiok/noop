...
- [Lift Log upstream state](lift-log-upstream-prs.md) — merged PRs; Lift Log PR #2403 and diagnostics PR #2402 both OPEN (nothing left to open); #2386 merged; details in `dist/STATE.md`.
